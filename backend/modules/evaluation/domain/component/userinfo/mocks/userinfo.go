...
func (m *MockUserInfoService) PackUserInfo(arg0 context.Context, arg1 interface{}) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "PackUserInfo", arg0, arg1)
}

// PackUserInfo indicates an expected call of PackUserInfo.
func (mr *MockUserInfoServiceMockRecorder) PackUserInfo(arg0, arg1 interface{}) *gomock.Call {
